...
/* To reduce stack size on embedded microcontroller platform */
typedef struct
{
    bs_t bs_frame;
...
int mp3dec_decode_frame(float gain, mp3dec_t *dec, mp3dec_work_t *work, const unsigned char *mp3, int mp3_bytes, mp3d_sample_t *pcm, mp3dec_frame_info_t *info);
